      ...
      <div className="card max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="relative inline-block mb-4">
            ...
            <div className="absolute inset-0 w-20 h-20 mx-auto bg-indigo-500/40 rounded-full blur-2xl" />
          </div>
        ...
        <button onClick={handleGoogleAuth} className="btn-secondary w-full flex items-center justify-center gap-3 text-lg py-3">
